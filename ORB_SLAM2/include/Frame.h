...
class Frame {
 public:
  ...
  // Computes rotation, translation and camera center matrices
  ...
  // Search a match for each keypoint in the left image
  // to a keypoint in the right image.
  ...
  // Backprojects a keypoint (if stereo/depth info available) into
