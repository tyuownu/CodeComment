...
{
  if ( argc != 6 ) {
    cerr << endl << "Usage: ./stereo_euroc path_to_vocabulary path_to_settings"
        " path_to_left_folder path_to_right_folder path_to_times_file" << endl;
    return 1;
  }
  ...
  LoadImages(string(argv[3]), string(argv[4]), string(argv[5]),
