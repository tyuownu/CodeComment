...
void Optimizer::OptimizeEssentialGraph(
  ...
  // Correct points. Transform to "non-optimized" reference keyframe
  // pose and transform back with optimized pose
...
int Optimizer::OptimizeSim3(
    KeyFrame *pKF1, KeyFrame *pKF2, vector<MapPoint *> &vpMatches1,
