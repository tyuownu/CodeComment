...
struct cpu {
  //  Vendor
  bool Vendor_AMD, Vendor_Intel;
  //  OS Features
  bool OS_x64, OS_AVX, OS_AVX512;
  //  Misc.
  bool HW_MMX, HW_x64, HW_ABM, HW_RDRAND, HW_BMI1,
       HW_BMI2, HW_ADX, HW_PREFETCHWT1, HW_MPX;
  //  SIMD: 128-bit
  bool HW_SSE, HW_SSE2, HW_SSE3, HW_SSSE3, HW_SSE41,
       HW_SSE42, HW_SSE4a, HW_AES, HW_SHA;
  //  SIMD: 256-bit
  bool HW_AVX, HW_XOP, HW_FMA3, HW_FMA4, HW_AVX2;
  //  SIMD: 512-bit
  bool HW_AVX512_F, HW_AVX512_PF, HW_AVX512_ER, HW_AVX512_CD, HW_AVX512_VL,
       HW_AVX512_BW, HW_AVX512_DQ, HW_AVX512_IFMA, HW_AVX512_VBMI;
