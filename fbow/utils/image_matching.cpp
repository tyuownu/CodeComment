// loads a vocabulary, and a image.
// Extracts image feaures and then  compute the bow of the image
#include "fbow.h"
#include <iostream>
#include <map>
using namespace std;
...
int main(int argc, char **argv)
{
  ...
  try {
    ...
    avgScore += double(std::chrono::duration_cast<std::chrono::milliseconds>(
            t_end - t_start).count());
    ...
    */
    std::cout << "avg score: " << avgScore << " # of features: "
