...
EntryId Database::add(const  cv::Mat &features,
...
EntryId Database::add(const std::vector<cv::Mat> &features,
                      BowVector *bowvec, FeatureVector *fvec) {
  BowVector aux;
...
void Database::query(const cv::Mat &features,
...
void Database::query(const std::vector<cv::Mat> &features,
                     QueryResults &ret, int max_results, int max_id) const {
  BowVector vec;
