...
% % check for Phased Array Toolbox
% if ~isempty( strfind( lower(which('rotx')), 'phased') )
%     fprintf('You have the Phased Array Toolbox installed such that it takes precedence\nover the Robotics Toolbox for MATLAB. This will cause serious problems.\n')
% else
